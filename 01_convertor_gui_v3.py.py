...
class Converter:
    ...
    def __init__(self):
        ...
        self.temp_result_error = Label(self.temp_frame, text="",
                                       fg="#9c0000")
        self.temp_result_error.grid(row=3)
    ...
    # check user input and if it's valid, converts temperature
    ...
    def output_answer(self):
        ...
        if has_error == "yes":
            ...
            self.temp_result_error.config(fg="#9C0000")
            self.temp_entry.config(bg="#F8CECC")

        else:
            self.temp_result_error.config(fg="#004C00")
            self.temp_entry.config(bg="#FFFFFF")

        self.temp_result_error.config(text=output)
